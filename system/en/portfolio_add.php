...
<div id="wrapper">
    ...
    if (isset($_POST['submit'])) {
        $portfolio_title_en = mysqli_real_escape_string($con, trim($_POST['portfolio_title_en']));
        $portfolio_title_ar = mysqli_real_escape_string($con, trim($_POST['portfolio_title_ar']));
        $display = $_POST['display'];



        $errors = array();
        if (empty($portfolio_title_en)) {
            $errors[] = "Please enter portfolio Name In English!";
        }
        if (empty($portfolio_title_ar)) {
            $errors[] = "Please enter portfolio Name In Arabic!";
        }
        ...
        if (!empty($errors)) {
            ...
            $con->query("INSERT INTO `portfolio` (`portfolio_title_en`, `portfolio_title_ar`, `display`) VALUES ('$portfolio_title_en', '$portfolio_title_ar','$display')");
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><?= lang('add_new_portfolio')?>  </li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="card-box">
                                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="portfolio_title_en" parsley-trigger="change"  placeholder="<?= lang('portfolio_title_en')?>" class="form-control" id="name_en">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="parent_cat_name_ar"> <?= lang('portfolio_title_ar')?></label>
                                        <input type="text" name="portfolio_title_ar" parsley-trigger="change"  placeholder="<?= lang('portfolio_title_ar')?>" class="form-control" id="name_ar">
                                    </div>
                                    <div class="form-group col-md-3">
