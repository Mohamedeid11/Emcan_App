                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                <li><a href="service_view.php"><?=lang('services_view')?> </a></li>
                            ...
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX<?= $service_id ?>">
                                        ...
                                        <td>
                                            <a href="<?= $service_image; ?>" class="image-popup" title="<?= $service_name_en; ?>">
                                                <img src="<?= $service_image; ?>" class="thumb-img" alt="<?= $service_name_en; ?>" height="100" style="width:100px;">
                                            </a>
                                        </td>
                                        <td>
                                            <?php if ($display == 1) { ?>
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="service_edit.php?serviceID=<?= $service_id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <td class="actions">
