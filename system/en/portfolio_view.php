                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><?= lang('portfolio')?>   </li>
                            </ol>
                        </div>
                    </div>
                    <h4>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th><?= lang('portfolio_title_en')?></th>
                                    <th><?= lang('portfolio_title_ar')?></th>
                                    <th><?= lang('status')?></th>
                                    <th><?= lang('date_add')?></th>
                                    <th><?= lang('action')?></th>
                                ...
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX<?= $id ?>">
                                        ...
                                        <td>
                                            <a href="projects_view_by_portfolio.php?portfolioID=<?=$id?>"><?= $portfolio_title_en ?></a>
                                        </td>

                                        <td>
                                            <a href="projects_view_by_portfolio.php?portfolioID=<?=$id?>"><?= $portfolio_title_ar ?></a>
                                        </td>

                                        <td>
                                            <?php if ($display == 1) { ?>
                                                <input class="change_status_off" data-id="<?=$id; ?>" type="checkbox"
                                                       checked
                                                       data-plugin="switchery" data-color="#81c868"/>
                                                <?php
                                            }else if ($display == 0) {
                                                ?>
                                                <input class="change_status_on" data-id="<?=$id; ?>" type="checkbox"
                                                       data-plugin="switchery" data-color="#81c868"/>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="portfolio_edit.php?portfolioID=<?= $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <td class="actions">
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/portfolio_function.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
